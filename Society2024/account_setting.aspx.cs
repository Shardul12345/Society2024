...
namespace Society
{
    public partial class account_setting : System.Web.UI.Page
    {
        ...
        public void runproc(string operation)
        {
            ...
            account.Society_Id = society_id.Value;
            account.Bill_Gen_Date = Convert.ToDateTime(DropDownList1.SelectedValue);
            account.Late_Fee_Tax_Per = Convert.ToInt32(DropDownList2.SelectedValue);
            account.Add_Facility = Convert.ToInt32(DropDownList3.SelectedValue);
            ...
            account.Add_Helper = Convert.ToInt32(DropDownList8.SelectedValue);
            account.Buy_Sale_Option = Convert.ToInt32(DropDownList9.SelectedValue);
