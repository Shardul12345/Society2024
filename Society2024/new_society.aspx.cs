...
namespace Society2024
{
    public partial class society1 : System.Web.UI.Page
    {
        ...
        protected void btn_new_Click(object sender, EventArgs e)
        {
            ...
            Details.Sql_Operation = "check_id";
            Details.Society_Id = society_id.Value;
            new_Registration.new_society(Details);
            ScriptManager.RegisterClientScriptBlock(this, GetType(), "Popup", "alert('First New  Registration After add Society ')", true);
            Response.Redirect("society_search.aspx?name");
