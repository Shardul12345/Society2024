        ...
        <div class="box-body">
           ...
           <%-- <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <asp:Label ID="Label1" runat="server" Text="Bill Generation Date"></asp:Label>
                    </div>
                    <div class="col-sm-4">
                        <asp:DropDownList ID="DropDownList1" class="form-control" runat="server">
                            <asp:ListItem Selected="True" Value="0">OFF</asp:ListItem>
             ...
             <div class="form-group">
                <div class="row">
                    <div class="col-sm-2">
                        <asp:Label ID="Label2" runat="server" Text="Late Fee Tax Per"></asp:Label>
                    </div>
                    <div class="col-sm-4">
                        <asp:DropDownList ID="DropDownList2" class="form-control" runat="server">
                            <asp:ListItem Selected="True" Value="0">OFF</asp:ListItem>
            ...
            <div class="form-group">
             ...
             <div class="box-header with-border">
                <h3 class="box-title" style="font-weight: bold">Other Facility</h3>
            </div>
             <div class="form-group">
                <div class="row">
                    <div class="col-sm-2">
                        <asp:Label ID="Label3" runat="server" Text="Add Facility"></asp:Label>
                    </div>
                    <div class="col-sm-4">
                        <asp:DropDownList ID="DropDownList3" class="form-control" runat="server">
                            <asp:ListItem Selected="True" Value="0">OFF</asp:ListItem>
                 ...
                 <div class="row">
                    <div class="col-sm-2">
                        <asp:Label ID="Label7" runat="server" Text="Add Helper"></asp:Label>
                    </div>
                    <div class="col-sm-4">
            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-sm-2">
                        <asp:Label ID="Label8" runat="server" Text="Buy Sale Option"></asp:Label>
                    </div>
                    <div class="col-sm-4">
