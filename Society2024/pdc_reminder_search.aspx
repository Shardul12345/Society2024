                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="form-group">
                                            <div class="row ">
                                                ...
                                                <div class="col-sm-4">
                                                    <asp:DropDownList ID="ddl_owner" runat="server" Height="32px" Width="200px" parsely-trigger="change" AutoPostBack="true" ></asp:DropDownList>
                                                    <br />
                                        ...
                                        <div class="form-group">
                                            <div class="row ">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:TextBox ID="txt_chq_no" runat="server" Height="30px" Width="150px" MaxLength="50" onkeypress="return digit(event);" OnTextChanged="txt_chq_no_TextChanged" AutoPostBack="true" placeholder="Cheque No"></asp:TextBox>
