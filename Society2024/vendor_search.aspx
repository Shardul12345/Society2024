                                    ...
                                    <ContentTemplate>
                                        <div class="form-group">
                                            <div class="row ">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:TextBox ID="txt_name" runat="server" Style="text-transform: capitalize;" MaxLength="50" placeholder="Enter Name" required> </asp:TextBox>
                                                    <br />
                                        ...
                                        <div class="form-group">
                                            <div class="row ">
                                                ...
                                                <div class="col-sm-3">
                                                    <asp:TextBox ID="txt_org_mob" runat="server" MaxLength="10" onblur="checkLength(this)" onkeypress="return digit(event);" placeholder="Enter Office Contact" required></asp:TextBox>
                                                    <br />
