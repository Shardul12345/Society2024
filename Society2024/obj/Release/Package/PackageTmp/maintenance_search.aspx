...
<%--                                            <div class="col-sm-2">
                                                <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Size="Medium" Text="Flat No"></asp:Label>
                                            ...
                                            <div class="col-sm-4">
                                                <asp:DropDownList ID="drp_flat_type" Width="100px" runat="server" OnSelectedIndexChanged="drp_flat_type_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                            </div>--%>
                                        </div>
                                    </div>
