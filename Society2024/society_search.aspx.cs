...
namespace Society
{
    public partial class society_search : System.Web.UI.Page
    {
        ...
        protected void btn_search_Click(object sender, EventArgs e)
        {
            ...
            sb.Append("Select * from society_master where active_status=0 and society_id='" + society_id.Value + "' ");
            if (txt_search.Text != "")
            {
        ...
        protected void btn_photo_upload_Click(object sender, EventArgs e)
        {
            ...
            if (file_name.HasFiles)
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "Pop", "$('#import_model').modal('show');", true);
    ...
    private int getUsage(string usage)
        ...
        {
            if(search_field.SelectedValue == "establish_date")
            {
