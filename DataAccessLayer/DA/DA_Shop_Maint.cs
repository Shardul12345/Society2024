...
namespace DataAccessLayer.DA
{
    public class DA_Shop_Maint
    {
        ...
        public DataSet Get_Shop_Maintenance(Shop_Maintenance maintenance)
        {
        ...
        public object shop_maint_search(Shop_Maintenance maintenance)
        {
            ...
            DataTable dt = new DataTable();
            data_item.Add(st.create_array("query", maintenance.Sql_Operation));
        ...
        public Shop_Maintenance Receipt_TextChanged(Shop_Maintenance maintenance)
        {
            ...
            if (status == "Done")
                if (sdr.Read())
                    maintenance.Sql_Result = "Alredy exist";
                else
